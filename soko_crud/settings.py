"""
Django settings for soko_crud project.
...
SECRET_KEY = "^x@93#g4t*-ie)k6xkg9l@@x&&!k5sgjkj5c^fu*1rth7-fasu"
...
WSGI_APPLICATION = 'soko_crud.wsgi.application'
